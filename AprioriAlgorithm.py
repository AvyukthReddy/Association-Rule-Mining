...
# Function that eliminates all the Itemsets with support less than min_support
...
# Printing all the possible Frequent Itemsets that satisfies min_support condition
...
print("\nTotal Time taken for Computation using Apriori Algorithm:", total_time)
